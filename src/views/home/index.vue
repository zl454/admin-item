...
import UnhandleLayout from "@/components/UnhandleLayout";
...
export default {
  data() {
    return {
      statisticalData: {},
      src1: require("@/assets/images/home_order.png"),
      src2: require("@/assets/images/home_today_amount.png"),
      src3: require("@/assets/images/home_yesterday_amount.png"),
    };
  },
  components: {
    MainMessage,
